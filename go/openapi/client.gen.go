...
type ListEvmAccountsParams struct {
	// Name The optional name of the account to get. If provided, the response will contain only the account with that name.
...
type CreateEvmAccountParams struct {
	// XWalletAuth The JWT signed using the Server Wallet Secret, encoded in base64.
	// See the Authentication section above for more details.
	XWalletAuth *XWalletAuth `json:"X-Wallet-Auth,omitempty"`

	// XIdempotencyKey The optional header for making requests safely retryable.
...
type CreateEvmSmartAccountJSONBody struct {
	// Name An optional name for the account.
	// Account names can consist of alphanumeric characters and hyphens, and be between 2 and 36 characters long.
	// Account names must be unique across all Smart Accounts the developer owns.
	Name *string `json:"name,omitempty"`
...
type PrepareUserOperationJSONBody struct {
	...
	Network *PrepareUserOperationJSONBodyNetwork `json:"network,omitempty"`
