...
async def test_create_account():
    ...
    mock_solana_accounts_api.create_solana_account = AsyncMock(
        return_value=mock_sol_account
    )
...
async def test_get_account():
    ...
    mock_sol_account.address = "test_sol_address"
    mock_sol_account.name = "test-sol-account"
    mock_solana_accounts_api.get_solana_account = AsyncMock(
        return_value=mock_sol_account
    )
...
async def test_get_account_by_name(server_account_model_factory):
    ...
    mock_solana_accounts_api.get_solana_account_by_name.assert_called_once_with(
        test_name
    )
...
async def test_list_accounts():
    ...
    mock_solana_accounts_api.list_solana_accounts = AsyncMock(
...
async def test_sign_message():
    ...
    mock_api_clients = AsyncMock()
    mock_api_clients.solana_accounts = mock_solana_accounts_api
    mock_solana_accounts_api.sign_solana_message = AsyncMock(
...
async def test_sign_transaction():
    ...
    mock_api_clients = AsyncMock()
    mock_api_clients.solana_accounts = mock_solana_accounts_api
    mock_solana_accounts_api.sign_solana_transaction = AsyncMock(
        return_value="test_signature"
    )
